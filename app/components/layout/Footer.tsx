        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-slate-100 dark:bg-white/20 rounded-lg flex items-center justify-center hover:bg-blue-100 dark:hover:bg-white/30 transition-colors group"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5 text-slate-600 dark:text-white group-hover:text-blue-600 dark:group-hover:text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
