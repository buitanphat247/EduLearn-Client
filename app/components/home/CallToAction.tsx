...
export default function CallToAction() {
  return (
    <section className="py-24 bg-slate-50 dark:bg-[#0f172a] relative border-t border-slate-200 dark:border-slate-800/50 transition-colors duration-300">
      {/* Background Decor */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[300px] bg-blue-200/50 dark:bg-blue-600/10 blur-[120px] rounded-full mix-blend-multiply dark:mix-blend-screen"></div>
      </div>

      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="inline-block px-3 py-1 mb-6 text-xs font-semibold tracking-wider text-green-600 dark:text-green-400 uppercase bg-green-50 dark:bg-green-500/10 rounded-full border border-green-200 dark:border-green-500/20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6 tracking-tight leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400">dậm chân tại chỗ</span>
          </h2>
          ...
          <div className="mt-8 flex items-center justify-center gap-6 text-slate-600 dark:text-slate-500 text-sm font-medium">
