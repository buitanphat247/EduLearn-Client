      ...
      <div className="lg:col-span-4">
        <div className="bg-[#1e293b] rounded-2xl p-6 border border-slate-700 shadow-xl relative overflow-hidden">
          ...
          <div className="space-y-6">
            {/* Language Field */}
            <div>
              <div className="h-5 w-24 bg-slate-700/50 rounded mb-2 animate-pulse" />
              <div className="h-10 w-full bg-slate-700/30 rounded-lg animate-pulse" />
            </div>
            ...
            <div>
              <div className="h-5 w-24 bg-slate-700/50 rounded mb-2 animate-pulse" />
              <div className="h-10 w-full bg-slate-700/30 rounded-lg animate-pulse mb-3" />
              <div className="h-10 w-full bg-slate-700/30 rounded-lg animate-pulse" />
            </div>

            {/* Submit Button */}
            <div className="h-11 w-full bg-slate-700/50 rounded-xl animate-pulse mt-8" />
          </div>
        </div>
      </div>
      ...
      <div className="lg:col-span-8">
        <div className="bg-[#1e293b] rounded-2xl p-6 border border-slate-700 shadow-xl">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="h-7 w-40 bg-slate-700/50 rounded-lg animate-pulse" />
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-slate-900/30 border border-slate-700/30 rounded-xl p-4">
                ...
                <div className="h-5 w-3/4 bg-slate-700/50 rounded animate-pulse mb-3" />
          ...
          {/* Bottom Button */}
          <div className="w-full h-9 mt-4 bg-slate-700/20 rounded-xl animate-pulse" />
        </div>
      </div>
    </div>
  );
