          ...
          {existingAttachments.map((attachment) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-800 truncate">{getFileName(attachment)}</p>
                <p className="text-xs text-gray-500 mt-0.5">{formatFileSize(getFileSize(attachment))}</p>
              </div>
              <span className="text-xs text-gray-400 px-2 py-1 bg-gray-100 rounded">Đã tải lên</span>
            </div>
          ))}
        </div>
      )}
        ...
        <div className="space-y-3 mb-4">
          ...
          {fileList.map((file) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-800 truncate">{getFileName(file)}</p>
