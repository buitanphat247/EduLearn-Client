...
interface SocialSidebarProps {
  ...
  setContactSubTab: (tab: "friends" | "groups" | "requests" | "sent_requests" | "blocked") => void;
        ...
        {bottomTab === "contacts" ? (
          ...
          <div className="py-2 px-2 flex flex-col gap-1">
            ...
            >
              ...
              <span className="font-medium">Danh sách chặn</span>
            </div>
          </div>
        ) : (
                  ...
                  <div className="flex flex-col flex-1 min-w-0 relative">
                    ...
                    <div className="flex items-center h-5">
                      ...
                      <div className="absolute right-0 bottom-0 flex items-center justify-end h-5 z-10">
                        {conversation.unread && conversation.id !== selectedConversation ? (
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              showConfirmModal({
                                title: '<span class="text-white">Xóa cuộc trò chuyện?</span>',
                                html: `<p class="text-slate-300">Bạn có chắc chắn muốn xóa cuộc trò chuyện với <strong class="text-white">${conversation.name}</strong>?</p>`,
                                confirmButtonText: 'Xóa đoạn chat',
